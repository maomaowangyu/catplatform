...
import com.galaxy.common.security.Digests;
import com.galaxy.common.security.shiro.session.SessionDAO;
import com.galaxy.common.service.BaseService;
import com.galaxy.common.service.ServiceException;
import com.galaxy.common.utils.CacheUtils;
import com.galaxy.common.utils.Encodes;
import com.galaxy.common.utils.StringUtils;
import com.galaxy.common.web.Servlets;
import com.galaxy.modules.sys.menu.persistence.MenuDao;
import com.galaxy.modules.sys.role.persistence.RoleDao;
import com.galaxy.modules.sys.user.persistence.UserDao;
...
import com.galaxy.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public List<Role> findRoleByUser(String id){
		List<Role> l = roleDao.findRoleByUser(id);
		return l;
	}
	...
	public void saveUser(User user) {
		...
		if (StringUtils.isNotBlank(user.getId())){
			...
			if (user.getRoleList() != null && user.getRoleList().size() > 0){
				...
				if (user.getRoleNamees().length() > 0) {
					String[] roleNames = user.getRoleNamees().split(",");
					for (int i = 0 , j = roleNames.length;i<j;i++) {
						Role r = new Role();
						r.setName(roleNames[i]);
						Role rr = roleDao.getByName(r);
						list.add(rr);
					}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public int getRoleALLCount(){
		return roleDao.getRoleALLCount();
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void saveMenu(Menu menu) {
		Menu m1 = this.getMenu(menu.getParent().getId());
		// 获取父节点实体
		menu.setParent(m1);
		menu.setLeave(m1.getLeave() + 1);
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://baseplatform.com\r\n");
		sb.append("\r\n======================================================================\r\n");
