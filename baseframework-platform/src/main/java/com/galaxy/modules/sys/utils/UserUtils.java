...
import com.galaxy.modules.sys.area.persistence.AreaDao;
import com.galaxy.modules.sys.menu.persistence.MenuDao;
import com.galaxy.modules.sys.office.persistence.OfficeDao;
...
public class UserUtils {
     ...
     * @return
     */
    public static List<Menu> getMenuListByLeaveOne() {
        @SuppressWarnings("unchecked")
        User user = getUser();
        Menu m = new Menu();
        m.setUserId(user.getId());
        m.setLeave(1);
        List<Menu> menuList = menuDao.findMenuLeaveByUserId(m);
        return menuList;
    }
     ...
     * @return
     */
    public static List<Menu> getLeftMenuList() {
        @SuppressWarnings("unchecked")
        User user = getUser();
        Menu m = new Menu();
        m.setUserId(user.getId());
        ...
        if (menuList != null && menuList.size() > 0) {
            ...
            m.setLeave(2);
            m.setParentfId(menu.getId());
            lmenuList = menuDao.findLeftMenuLeaveByUserId(m);
        }
        return lmenuList;
    }
     ...
     * @return
     */
    public static List<Menu> getLeftLeaceMenuList() {
        @SuppressWarnings("unchecked")
        User user = getUser();
        Menu m = new Menu();
        m.setUserId(user.getId());
