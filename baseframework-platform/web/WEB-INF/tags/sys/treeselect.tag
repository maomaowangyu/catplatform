...
<%@ attribute name="placeholder" type="java.lang.String" required="false" description="默认提示信息"%>
...
<div class="input-append" >
	...
	<input id="${id}Name" name="${labelName}" ${allowInput?'':'readonly="readonly"'} type="text" value="${labelValue}" data-msg-required="${dataMsgRequired}"
		class="${cssClass}" placeholder="${placeholder}" style="${cssStyle}"/><a id="${id}Button" href="javascript:" class="btn ${disabled} ${hideBtn ? 'hide' : ''}" style="${smallBtn?'padding:4px 2px;':''}">&nbsp;<i class="fa fa-search"></i>&nbsp;</a>&nbsp;&nbsp;
</div>
