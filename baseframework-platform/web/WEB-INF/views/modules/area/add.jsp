                ...
                <div class=" form">
                    <form:form id="inputForm" modelAttribute="area"  method="post" class="cmxform form-horizontal adminex-form">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <form:input path="code"  cssClass="form-control" cssErrorClass="error" htmlEscape="false" maxlength="50"/>
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <form:textarea path="remarks" htmlEscape="false" rows="3"  cssErrorClass="error" maxlength="200" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
