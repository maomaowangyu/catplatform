...
<head>
    ...
    <title><spring:message code="dict.add" /></title>
                ...
                <div class=" form">
                    <form:form id="inputForm" modelAttribute="dict"  method="post" class="cmxform form-horizontal adminex-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <select id="type" name="type" class="sender_user_search required"  style="width: 150px"  ></select>
                            </div>
                        </div>
                        <div class="form-group">
