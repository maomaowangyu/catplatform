...
<head>
    ...
    <title><spring:message code="office.add" /></title>
                ...
                <div class=" form">
                    <form:form id="inputForm" modelAttribute="office"  method="post" class="cmxform form-horizontal adminex-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <sys:treeselect id="area" name="area.id" value="${office.area.id}"
                                                ...
                                                title="地区" url='/area/treeData.do'  cssClass="required" cssStyle="height: 34px;padding: 6px 12px; font-size: 14px;line-height: 1.42857143;color: #555;background-color: #fff;background-image: none; border: 1px solid #ccc;border-radius: 4px;-webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075);box-shadow: inset 0 1px 1px rgba(0,0,0,.075);font-family:'微软雅黑'" />
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <form:select path="type" class="form-control m-bot15" cssErrorClass="error" >
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <form:select path="grade" class="form-control m-bot15" cssErrorClass="error" >
                        ...
                        <div class="form-group ">
                            <label class="control-label col-lg-2 ftext"><spring:message code="leave" />:</label>
                            <div class="col-lg-6">
                                <form:select path="useable" class="form-control m-bot15" cssErrorClass="error">
