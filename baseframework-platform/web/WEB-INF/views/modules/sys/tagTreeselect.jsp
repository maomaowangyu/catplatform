...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true},
				async:{enable:(type==3),url:"${ctx}/user/treeData",autoParam:["id=officeId"]},
...
<body>
	<div style="position:absolute;right:8px;top:15px;cursor:pointer;font-size:14px; font-family:'微软雅黑'" onclick="search();">
		<i class="fa-search"></i><label id="txt">搜索</label>
	</div>
	<div id="search" class="form-search hide" style="padding:10px 0 0 13px;">
		<label for="key" class="control-label" style="padding:5px 5px 3px 0;font-size:14px; font-family:'微软雅黑'">关键字：</label>
		<input type="text" class="empty" id="key" name="key" maxlength="50" style="width:110px;">
		<button class="btn" id="btn" style="font-size:14px; font-family:'微软雅黑'" onclick="searchNode()">搜索</button>
	</div>
	<div id="tree" class="ztree" style="padding:15px 20px;font-size:14px; font-family:'微软雅黑'"></div>
</body>