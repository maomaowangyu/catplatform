                ...
                <div class=" form">
                    <form:form id="inputForm" modelAttribute="user"  method="post" class="cmxform form-horizontal adminex-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <form:input path="newPassword" type="password" htmlEscape="false" maxlength="50" pas="true" cssErrorClass="error" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-2 ftext"><spring:message code="user.confirmpassword" />:</label>
                            <div class="col-lg-5">
                                <form:input path="confirmNewPassword" type="password" equalTo="#newPassword" htmlEscape="false" maxlength="50"  cssErrorClass="error" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
