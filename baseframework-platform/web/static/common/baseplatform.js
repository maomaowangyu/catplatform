...
function layerLoadinghiden() {
    layer.closeAll();
}

function message() {
    var rsa = $("#rmessage").html();
    if (rsa != null && rsa != '') {
        $("#messagediv").slideToggle("slow");
        setTimeout(function (){
            if (rsa != null && rsa != '') {
                var f= $("#messagediv").is(":hidden");
                if (!f) {
                    $("#messagediv").slideToggle("slow");
                }
            }
...
function ajaxSubmitPostFile(href) {
    layerLoadingShow();
