...
import com.galaxy.common.persistence.TreeEntity;
...
public abstract class TreeService<D extends TreeDao<T>, T extends TreeEntity<T>> extends CrudService<D, T> implements TreeInterface<T>{
