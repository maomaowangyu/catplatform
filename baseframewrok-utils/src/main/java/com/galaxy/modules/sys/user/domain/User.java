 ...
 */
package com.galaxy.modules.sys.user.domain;
...
import com.galaxy.common.supcan.annotation.treelist.cols.SupCol;
import com.galaxy.common.utils.Collections3;
import com.galaxy.common.utils.excel.annotation.ExcelField;
import com.galaxy.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private String confirmNewPassword;// 密码
	...
	private String serchname;	// 查询名称
	private String roleName;	// 查询名称
	private int diglossia;	// 双语
	...
	private String roleNames;	// 上次登陆IP
	...
	public int getDiglossia() {
		return diglossia;
	}

	public void setDiglossia(int diglossia) {
		this.diglossia = diglossia;
	}
